@echo off
rem Builds the Karen Android app: mobile\build\app\outputs\flutter-apk\app-release.apk
...
copy /y "build\app\outputs\flutter-apk\app-release.apk" "%~dp0Karen.apk" >nul
echo.
echo Built: %~dp0Karen.apk
